...
public class LojaController {
	...
	public List<Produto> getTodosEmPromocao() {
		...
		String query = "SELECT p FROM Produto p " + "WHERE p.desconto > 0";
	...
	public DataModel getProdutosCat() {
		...
		String cat = (String) FacesContext.getCurrentInstance()
				.getExternalContext().getRequestParameterMap().get("cat");
		...
		String query = "SELECT p FROM Produto p WHERE p.categoria.id=:id";
