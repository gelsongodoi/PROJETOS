...
/**
 * Classe com métodos para executar comandos do Windows.
 * 
 */
public class WindowsCommandUtils {

	/**
	 * Executa um comando do Windows que não está associado ao cmd.exe, ou seja,
	 * qualquer executável alcançável pela configuração da variável de ambiente
	 * PATH.
	 * 
	 * @param command
	...
	/**
	 * Executa um comando do Windows que está associado ao cmd.exe, por exemplo,
	 * o comando DIR.
	 * 
	 * @param command
	 *            Comando a ser executado.
