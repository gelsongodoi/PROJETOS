...
import br.com.deserve.util.LeArquivo_v2;
 ...
 * @author Gelson
 */
public class FrmConfig_v5 extends javax.swing.JDialog {
    ...
    public FrmConfig_v5() throws FileNotFoundException {
        initComponents();
        ...
        LeArquivo_v2 leArq = new LeArquivo_v2();
        ...
        if (System.getenv("KETTLE_HOME_v5").equals("")) {
            jLabelKettle_Home.setText("Nao encontrada!");
        } else {
            txtKettleH.setText(System.getenv("KETTLE_HOME_v5"));
        }

        String kettle_home = System.getenv("KETTLE_HOME_v5");
        ...
        LeArquivo_v2 leArq1 = new LeArquivo_v2();
        ...
        if (diretorio.equals("")) {
            jLabelDirProjeto
                    .setText("C:\\SiSAD_v5\\data-integration\\Projetos\\MATRIZ\\");
        } else {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Versão 5");

        jCBAlteraVersao.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Alterar versão", "SiSAD v4" }));
    ...
    private void jCBAlteraVersaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCBAlteraVersaoActionPerformed
        ...
        if (a == 1) {
            try {
                ...
                FrmConfig_v4 frm4 = new FrmConfig_v4();
    ...
    private void jButtonConexaoActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonConexaoActionPerformed
        ...
        if (jRadioDatacenter.isSelected()) {
            ...
            try {
                ...
                jButtonConexao.setCursor(Cursor
                        .getPredefinedCursor(Cursor.DEFAULT_CURSOR));
                Logger.getLogger(FrmConfig_v5.class.getName()).log(Level.SEVERE,
                        null, ex);
            }
            jButtonConexao.setCursor(Cursor
                    .getPredefinedCursor(Cursor.DEFAULT_CURSOR));
            ...
            if (jCheckBoxOracle.isSelected() || jCheckBoxMSSQL.isSelected()) {
                ...
                if (jCheckBoxOracle.isSelected()) {
                    ...
                    try {
                        ...
                        jButtonConexao.setCursor(Cursor
                                .getPredefinedCursor(Cursor.DEFAULT_CURSOR));
                        Logger.getLogger(FrmConfig_v5.class.getName()).log(
