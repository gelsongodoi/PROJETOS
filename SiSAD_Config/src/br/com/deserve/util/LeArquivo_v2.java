...
public class LeArquivo_v2 {
    ...
    public Parametros readAllProperties() {
        ...
        String arquivoVersao = endereco.getCaminho_v2()+ "\\.kettle\\";
        ...
        try {
            ...
            JOptionPane
                    .showMessageDialog(
                            ...
                            + NomeArq
                            + "'. \r\n\n"
                            + "Aponte a variavel de ambiente KETTLE_HOME_v5 para \r\n"
    ...
    public void writeOBS(String qtde, String kettle) {
        ...
        try {
            ...
            WindowsCommandUtils.runCommand("SETX /M KETTLE_HOME_v5 " + kettle);
